...
app.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      res.status(200).json({ message: "Form submitted successfully", id, tokenID });
    } catch (error) {
...
app.post('/fraud-analyze', (req, res) => {
  ...
  if (
    ...
    (facilitation && (facilitation.includes('user') || facilitation.includes('candidate') || facilitation.includes('subscriber'))) ||
    ...
    subject.includes('urgent') || // Add more subject-related conditions as needed
