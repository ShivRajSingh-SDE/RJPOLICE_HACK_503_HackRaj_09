...
export default function Header() {
  ...
  return (
    <div className=" ">
      <div className=" bg-[white] p-1 rounded-b  items-center flex flex-row justify-between border-b mx-auto ">
      ...
      mx-auto p-3 bg-[#ffffff] shadow-[#b7a9eb63] border sticky z-50 top-0 flex justify-between items-center duration-300 shadow-2xl rounded-br-3xl rounded-bl-3xl"
      >
        {toggle ? (
          <AiOutlineSlackSquare
            onClick={toggleMenu}
      ...
      <div className=" bg-[#00ffd567] max-w-[1500px] rounded-b-2xl flex items-start   mx-auto">
        <ul className="  flex flex-start space-x-4 p-1">
          ...
          <li className=" p-2  bg-[white] rounded-2xl drop-shadow-2xl hover:scale-105 ease-in-out">
            <Link to="">Application Track</Link>
          </li>
